...
(function () {
  ...
  const NAV = [
    ...
    { key: 'stats', href: 'stats.html', label: 'الإحصائيات', perm: 'view_stats',
      icon: '<path d="M5 9.2h3V19H5V9.2zM10.6 5h2.8v14h-2.8V5zm5.6 8H19v6h-2.8v-6z"/>' },
    { key: 'featured', href: 'featured.html', label: 'المشاريع المميزة', perm: 'manage_featured',
      icon: '<path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>' },
    { key: 'materials', href: 'materials-admin.html', label: 'سوق المواد', perm: 'manage_materials',
      icon: '<path d="M19 7h-3V6a4 4 0 0 0-8 0v1H5a1 1 0 0 0-1 1v11a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V8a1 1 0 0 0-1-1zM10 6a2 2 0 0 1 4 0v1h-4V6z"/>' },
    { key: 'credits', href: 'credits.html', label: 'رصيد النقاط', perm: 'adjust_credits',
