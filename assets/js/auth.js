...
(function () {
  ...
  // ============================================================
  // GUEST LOGIN — entrance for visitors without accounts
  // ============================================================
  ...
  function initGuestLogin() {
    ...
    btn.addEventListener('click', async () => {
      ...
      try {
        let guestId = localStorage.getItem('elm_guestId');
        if (!guestId) {
          ...
          localStorage.setItem('elm_guestId', guestId);
        }

        await apiCall('/auth/guest', {
          method: 'POST',
